...
import static tomrowicki.mario.MarioBros.V_HEIGHT;
import static tomrowicki.mario.MarioBros.V_WIDTH;
...
public class GameOverScreen implements Screen {
    ...
    public GameOverScreen(Game game) {
        ...
        table.center();
        table.setFillParent(true); // table won't take up the entire stage
