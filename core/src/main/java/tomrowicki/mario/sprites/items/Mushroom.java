...
public class Mushroom extends Item {
    ...
    public void defineItem() {
        ...
        fdef.filter.categoryBits = ITEM_BIT; // what this fixture is
        fdef.filter.maskBits = MARIO_BIT | OBJECT_BIT | GROUND_BIT | COIN_BIT | BRICK_BIT; // what it can collide with
